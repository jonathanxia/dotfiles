...
function __promptline_ {
  ...
  local b_bg="${wrap}48;5;254${end_wrap}"
  local b_sep_fg="${wrap}38;5;254${end_wrap}"
  local c_fg="${wrap}1;97;38;5;232${end_wrap}"
  local c_bg="${wrap}48;5;248${end_wrap}"
  local c_sep_fg="${wrap}38;5;248${end_wrap}"
