...
function __promptline {
  ...
  local a_fg="${wrap}1;97;38;5;231${end_wrap}"
  local a_bg="${wrap}48;5;52${end_wrap}"
  local a_sep_fg="${wrap}38;5;52${end_wrap}"
  local b_fg="${wrap}1;97;38;5;231${end_wrap}"
  local b_bg="${wrap}48;5;88${end_wrap}"
  local b_sep_fg="${wrap}38;5;88${end_wrap}"
  local c_fg="${wrap}1;30;38;5;232${end_wrap}"
